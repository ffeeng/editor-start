...
export const TIPTAP_COLLAB_APP_ID =
  process.env.NEXT_PUBLIC_TIPTAP_COLLAB_APP_ID || "x9lz4y6m"
export const TIPTAP_COLLAB_TOKEN =
  process.env.NEXT_PUBLIC_TIPTAP_COLLAB_TOKEN || "cf2217fa76a1a08367040e05bd3756776908ca1d589c08eddb052c9e8b074195"

// TipTap AI
export const TIPTAP_AI_APP_ID = process.env.NEXT_PUBLIC_TIPTAP_AI_APP_ID || "x9lz4y6m"
export const TIPTAP_AI_TOKEN = process.env.NEXT_PUBLIC_TIPTAP_AI_TOKEN || "cMZ162reoPVetu1mVTVwrD5JLUqNg7S4sJyg1DFKN8RodiYSTMTHOOPni0PsjxZ1"
